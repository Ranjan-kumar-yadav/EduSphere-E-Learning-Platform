    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-10 text-center">
                <h1 class="display-3 text-white animated slideInDown">Accepted Bookings</h1>
...
";
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="complete_booking_status.php?id=<?php echo $row['booking_id']; ?>"><button class="btn btn-primary">Complete</button></a>
